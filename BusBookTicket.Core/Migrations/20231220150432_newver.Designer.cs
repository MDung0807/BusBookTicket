...
namespace BusBookTicket.Core.Migrations
{
    ...
    [Migration("20231220150432_newver")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusBookTicket.Core.Models.Entity.PriceClassification", b =>
                {
                    b.HasOne("BusBookTicket.Core.Models.Entity.Company", "Company")
                        .WithOne("PriceClassification")
                        .HasForeignKey("BusBookTicket.Core.Models.Entity.PriceClassification", "CompanyId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("BusBookTicket.Core.Models.Entity.RouteDetail", b =>
                {
                    ...
                    b.HasOne("BusBookTicket.Core.Models.Entity.StopStation", "StopStation")
                        .WithOne("RouteDetail")
                        .HasForeignKey("BusBookTicket.Core.Models.Entity.RouteDetail", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("BusBookTicket.Core.Models.Entity.Routes", "Routes")
                        .WithOne("RouteDetail")
                        .HasForeignKey("BusBookTicket.Core.Models.Entity.RouteDetail", "RouteId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("BusBookTicket.Core.Models.Entity.StopStation", b =>
                {
                    ...
                    b.HasOne("BusBookTicket.Core.Models.Entity.Prices", "Prices")
                        .WithMany()
